...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/notifications.NotificationCursorPage"
                        }
                    },
                    "401": {
                        "description": "Not authenticated",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/posts.PostCursorPage"
                        }
                    },
                    "422": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/posts.LikeResponse"
                        }
                    },
                    "401": {
                        "description": "Not authenticated",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/posts.RepostResponse"
                        }
                    },
                    "401": {
                        "description": "Not authenticated",
                    ...
                    "422": {
                        "description": "Cannot repost a repost",
                        "schema": {
                            "$ref": "#/definitions/types.AppError"
                        }
                    },
    ...
    "definitions": {
        ...
        "notifications.NotificationCursorPage": {
            "type": "object",
            "properties": {
                "has_more": {
                    "type": "boolean"
        ...
        "posts.PostResponse": {
            ...
            "properties": {
                ...
                "link_preview": {
                    "$ref": "#/definitions/posts.LinkPreviewResponse"
                },
                "media": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/posts.MediaResponse"
                    }
                },
                "parent_id": {
                    "type": "string"
