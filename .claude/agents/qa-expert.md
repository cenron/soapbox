...
**NOTE**
- Generate a comprehensive testing plan and save it to the root of the project as TEST_PLAN.MD before doing anything else.
- Use Playwright MCP server to do user journey workflows testing all actions and functions on each page.
